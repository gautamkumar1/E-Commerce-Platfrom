    ...
    <div className="flex min-h-screen w-full bg-muted/40">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span className="sr-only">Create Products</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Create Products</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
      ...
      <div className="flex flex-1 flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          ...
          <div className="flex-1 md:grow-0">
            <h1 className="text-lg font-semibold">Shopaholic</h1>
          </div>
      ...
      <DropdownMenuContent className="w-56" align="end" forceMount>
          ...
          <Card className="mb-4">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>Welcome to ShopaHolic Store</CardTitle>
                  <CardDescription>Hello, Gautam Kumar! Manage your store and track your sales.</CardDescription>
                </div>
        ...
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 pt-10">
            <Card>
              <CardHeader>
                <CardTitle>Total Products</CardTitle>
                <CardDescription>The total number of products in your inventory.</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The total number of customers in your database.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-between">
                <div className="text-4xl font-bold">1,456</div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The total number of orders placed by your customers.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-between">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>The total revenue generated from all orders.</CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-between">
